  ...
  try {
    ...
    if ((storeCount?.c ?? 0) === 0) {
      await db.insert(stores).values([
        ...
        { name: "Unidade Bal. Esplanada",   address: "R. Antônio Lima, S/N — Balneário Esplanada",   city: "Jaguaruna — SC",        lat: "-28.760298", lng: "-49.127100", mapsUrl: "https://maps.google.com/?cid=17105075346311767577&hl=pt-BR&gl=BR",                                                      order: 6, active: true },
        { name: "Unidade Bal. Campo Bom",   address: "R. José Cândido Coelho — Balneário Campo Bom", city: "Jaguaruna — SC",        lat: "-28.719280", lng: "-49.060922", mapsUrl: "https://maps.google.com/?cid=7982292855595746525&hl=pt-BR&gl=BR",                                                       order: 7, active: true },
